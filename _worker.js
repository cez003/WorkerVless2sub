...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-eez.pages.dev/ip.txt?token=4233523cez', //可参考内容格式 自行搭建。
...
let DLS = 8;//速度下限
let addressescsv = [
	'https://cf-workers-text2kv-eez.pages.dev/result.csv?token=4233523cez', //iptest测速结果文件。
];
